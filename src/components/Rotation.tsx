...
//       {/* Outer ring */}
//       <div className="absolute inset-0 flex justify-center items-center">
//         <div className="w-48 h-48 border-2 border-gray-300 rounded-full bg-yellow-200"></div>
//       </div>
//       {/* Inner rotating ball */}
//       <div className="absolute inset-0 flex justify-center items-center">
//         <div
//           className="w-24 h-24 border border-gray-300 rounded-full bg-red-300"
//           style={{
//             transform: `rotate(${rotationAngle}deg) translateX(120px)`,
//           }}
//         >
//           <div
